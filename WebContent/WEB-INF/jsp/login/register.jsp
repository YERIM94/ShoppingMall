...
<ei:layoutRender name="/view/layout/basic-layout.jsp">
	<ei:layoutComponent name="eiLayoutTitle">회원가입</ei:layoutComponent>
	...
	<script>
		...
		<ei:layoutComponent name="eiCssFormat">shero</ei:layoutComponent>
			...
			<div id="page-container"
				style="width: 60%; margin-left: auto; margin-right: auto; margin-top: auto; margin-botton: auto; padding-top: 50px;"">
				<p class="font-weight-light"
					style="font-size: 40px; margin-bottom: 0px;">Sign Up</p>
				<p
					style="font-size: 16px; margin-bottom: 20px;">회원가입
				</p>
				...
				<form action="DoRegister();" method="post" name="form1"
					FormEvent="true">
					<div style="width: 50%;">
					<label>* 모든 정보를 필수로 기입해야 합니다</label>
					<div></div>
						<label>가입정보</label>
					...
					<div class="input-group mb-3">
						...
						<button class="btn btn-outline-secondary" type="button"
							style="margin-top: 0px;">중복확인</button>
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" aria-label="ID"
							aria-describedby="basic-addon1" name="usr_nm">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" aria-label="ID"
							...
							name="usr_email"> <select class="custom-select"
					...
					<button type="submit" onclick="DoRegister();"
						...
						style="margin-top: 10px; float: right; width: 15%">가입하기</button>
				</form>
			</div>
